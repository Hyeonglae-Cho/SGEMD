...
custom_colours1 = c('#00008D', '#002AFF', '#00D4FF', '#2AFFD4', '#FFFF00', '#FF8D00', '#FF0000')

# The 'plot_signal' function below is the original version of the 'plot_signal1' function and is licensed under LGPL 2.1.
